    ...
    <svg id="logo-37" width="42" height="38" viewBox="0 0 42 38" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     <div>
      <ul id="navbar">
        ...
        <li>
          <Link to="/screening">Vehicle Screening</Link> 
          </li>
          <li>
        ...
        {/* <li>
          <Link to="/match">Match Plate Number</Link>
        </li> */}
     ...
     {/* <div className="hamburger-menu">
            <a href="index.html" onClick={() => setShowMediaIcons(!showMediaIcons)}>
              <GiHamburgerMenu />
            </a>
          </div> */}
    </nav>
